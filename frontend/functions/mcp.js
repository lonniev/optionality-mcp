/**
 * Cloudflare Pages Function — proxy /mcp to optionality-mcp.fastmcp.app/mcp.
 *
 ...
 *
 * Mirrors taxsort-mcp/frontend/functions/mcp.js verbatim with the
 * upstream host swapped.
 */

const UPSTREAM = "https://optionality-mcp.fastmcp.app/mcp";
...
export async function onRequest(context) {
  ...
  upHeaders.set("Host", "optionality-mcp.fastmcp.app");
